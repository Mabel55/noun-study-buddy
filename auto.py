...
# Make Groq with Gemma 2 primary
available_llms.append(ChatGroq(model="gemma2-9b-it", temperature=0.1, max_tokens=4000, api_key=os.environ.get("GROQ_API_KEY", "fallback-key")))
