  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { backgroundColor: colors.headerBg }]}>
        ...
        <Text style={styles.headerSub}>Plan your exam preparation</Text>
      </View>
        ...
        {!isLoggedIn ? (
          <View style={[styles.card, { backgroundColor: colors.card }]}>
            ...
            <Text style={[styles.desc, { color: colors.textSecondary }]}>
              Log in to set your exam dates, get a personalized daily study plan, and receive reminders!
            </Text>
          ...
          <View style={[styles.card, { backgroundColor: colors.card }]}>
            ...
            <Text style={[styles.desc, { color: colors.textSecondary }]}>
              The study planner with exam countdowns, daily tasks, and automatic scheduling is being built!
            </Text>
          </View>
        )}
      </View>
