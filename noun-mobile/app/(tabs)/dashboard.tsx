        ...
        {!isLoggedIn ? (
          <View style={[styles.card, { backgroundColor: colors.card }]}>
            ...
            <Text style={[styles.desc, { color: colors.textSecondary }]}>
              Create an account to track your scores, view your progress charts, and see your readiness level for each course.
            </Text>
          ...
          <View style={[styles.card, { backgroundColor: colors.card }]}>
            ...
            <Text style={[styles.desc, { color: colors.textSecondary }]}>
              Your personal dashboard with score history, readiness levels, and study streaks is being built!
            </Text>
          </View>
        )}
      </View>
